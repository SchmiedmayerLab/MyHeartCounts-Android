...
class MHCStudyBundleProviderImpl(
    ...
    private fun unpack(): StudyBundle {
        val target = File(context.cacheDir, CACHE_DIRECTORY).resolve(BuildConfig.STUDY_BUNDLE_ASSET_PATH)
        target.deleteRecursively()
        copyAsset(path = BuildConfig.STUDY_BUNDLE_ASSET_PATH, target = target)
